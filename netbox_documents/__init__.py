...
class NetboxDocuments(PluginConfig):
    ...
    description = 'Manage site, circuit, device and devicetype diagrams and documents in Netbox'
    version = '0.3.1'
    base_url = 'documents'
    default_settings = {
